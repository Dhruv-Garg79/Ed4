...
class VideoFileAdapter(private val listener: VideoFileAdapter.OnItemClickListener) : RecyclerView.Adapter<VideoFileAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: VideoFileAdapter.MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if (holder.desText.isVisible){
                holder.desText.visibility = View.GONE
                holder.desTitle.visibility = View.GONE

            }else{
                holder.desText.visibility = View.VISIBLE
                holder.desTitle.visibility = View.VISIBLE
            }
        }
    }
    ...
    class MyViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview){
        ...
        val desTitle : TextView = itemview.descriptionTitle
        val desText : TextView = itemview.descriptionText
    }
